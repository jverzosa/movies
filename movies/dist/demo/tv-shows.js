...
let TVShows = class TVShows extends LitElement {
    constructor() {
        super(...arguments);
        this.tvShows = [];
        this.content = getTVShows('');
    }
    render() {
...
__decorate([
    property()
], TVShows.prototype, "tvShows", void 0);
__decorate([
    property()
], TVShows.prototype, "seachQuery", void 0);
__decorate([
    state()
], TVShows.prototype, "content", void 0);
TVShows = __decorate([
